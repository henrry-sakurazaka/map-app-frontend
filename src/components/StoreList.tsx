...
const StoreList: React.FC = () => {
  ...
  return (
    <div className="lg:w-1/3 bg-white p-4 rounded-xl shadow-lg h-[60vh] lg:h-[70vh] overflow-y-auto">
      ...
      {stores.length === 0 ? (
        ...
        stores.map(store => (
          <div
            key={store.id}
            className="p-3 mb-2 border border-gray-100 rounded-lg hover:bg-blue-50 hover:border-blue-200 cursor-pointer"
